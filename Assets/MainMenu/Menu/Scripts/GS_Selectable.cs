...
public class GS_Selectable : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerUpHandler, ISubmitHandler, ISelectHandler {
    ...
    void Update() {
        ...
        if (ShowPanels.instance.currentMouseOverGameObject == gameObject && Input.mousePosition != lastPointerPositon) {
    ...
    public void OnPointerEnter(PointerEventData eventData) {
        ShowPanels.instance.currentMouseOverGameObject = gameObject;
        EventSystem.current.SetSelectedGameObject(gameObject);
    }
    public void OnPointerExit(PointerEventData eventData) {
        ShowPanels.instance.currentMouseOverGameObject = null;
    }
    ...
    public void OnPointerUp(PointerEventData eventData) {
        ...
        ShowPanels.instance.currentButton = button;
