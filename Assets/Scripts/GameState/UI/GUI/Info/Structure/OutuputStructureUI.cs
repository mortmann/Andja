...
namespace Andja.UI.Model {
    ...
    public class OutuputStructureUI : InfoUI {
        ...
        public override void OnShow(object ustr) {
        ...
        private void OnStructureDestroy(Structure str, IWarfare destroyer) {
            UIController.Instance.CloseOutputStructureUI();
        }
        ...
        public override void OnClose() {
            currentStructure.UnregisterOnDestroyCallback(OnStructureDestroy);
