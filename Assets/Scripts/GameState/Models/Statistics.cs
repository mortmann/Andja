...
public class Statistics {
    UnitStatistic unitStatistic;
    CityStatistic cityStatistic;
    StructureStatistic structureStatistic;
    DiplomaticStatistic diplomaticStatistic;
    WarStatistics warStatistic;
    ...
    [JsonObject]
    class StructureStatistic : Statistic {
        public int Built;
        public int Destroyed;
        public int Lost;
    ...
    [JsonObject]
    class DiplomaticStatistic : Statistic {
