...
public class ShortcutUI : MonoBehaviour {
    ...
    GameObject shortCutDraggedParent;

    List<GameObject> shortcutsGO;
    Dictionary<GameObject,GameObject> shortcutParentToButton;
    // Use this for initialization
    void Awake() { //has to be before uicontroller so it can be loaded
        if (Instance != null) {
