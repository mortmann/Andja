    ...
    public class IdleMouseState : BaseMouseState {
        ...
        public override void Update() {
            if (EventSystem.current.IsPointerOverGameObject() == false &&
                InputHandler.GetMouseButtonDown(InputMouse.Primary)) {
        ...
        public void MakeRaycastToCheckWhatTodo() {
            ...
            if (targetableHoldingScript != null) {
                ...
                if (GameData.FogOfWarStyle == FogOfWarStyle.Always &&
                    targetableHoldingScript.IsCurrentlyVisible == false) {
                    return;
                }

                MouseController.Instance.SelectUnit(targetableHoldingScript.Unit);
            }
                ...
                if (t.Structure != null && (t.Structure.HasHitbox ||
                                            t.Structure is RoadStructure == false &&
                                            t.Structure is GrowableStructure == false)) {
